...
export default class EditClientProfile extends React.Component {
    ...
    async getOwner() {
        ...
        const url = "https://main-backend-sprint-02.herokuapp.com/v1/authentication/user";
    ...
    async handleUpdate() {
        var token = sessionStorage.getItem('token');
        const urlUpdate = "https://main-backend-sprint-02.herokuapp.com/v1/authentication/user/edit"

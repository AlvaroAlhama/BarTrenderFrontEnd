...
function DashboardQRList(props) {
  ...
  useEffect(() => {
      const apiUrl =
        "https://bartrenderoficial.herokuapp.com/v1/payments/establishments/" +
        idEstablishment +
        "/calculate";
  ...
  if (!appState.discounts.results || appState.discounts.count === 0) {
    ...
    const paymentUrl = "https://bartrenderoficial.herokuapp.com/v1/payments/establishments/"+idEstablishment+"/pay";
